...
/*-----------------------------------------------
              @(target):= _PiavcaGlut.so
  ------------------------------------------------*/
#define SWIG_init    init_PiavcaGlut

#define SWIG_name    "_PiavcaGlut"
...
#include "c:\dev\Piavca\piavca-svn\Python\Piavca\PiavcaGlut\PiavcaGlut_wrap.h"
...
SWIGINTERN PyObject *_wrap_displayFunc(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)":displayFunc")) SWIG_fail;
  displayFunc();
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"No matching function for overloaded 'init'");
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_timeStep(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)":timeStep")) SWIG_fail;
  timeStep();
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_outputMessage(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:outputMessage",&obj0)) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(obj0, &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "outputMessage" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = buf1;
  outputMessage(arg1);
  resultobj = SWIG_Py_Void();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"outputMessage", _wrap_outputMessage, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
