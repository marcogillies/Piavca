...
class AnimationInterface(wx.Frame):
	...
	def __init__(self,parent,id, title, avatar, motion, motion_name):
		...
		filemenu.Append(ID_DISTANCE_MEASURE, "&ShowDistances"," Print the distance between the current frame and any frames displayed in the future")
		...
		wx.EVT_MENU(self, ID_DISTANCE_MEASURE, self.tracks.ShowDistances) 
