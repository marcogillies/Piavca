...
private:
    mutable swig::PyObject_var vtable[31];
#endif
...
public:
    ...
    virtual Piavca::Vec getCombinedVecValue(int trackId, float time);
    virtual Piavca::Quat getCombinedQuatValue(int trackId, float time);
...
public:
    SwigDirector_ChangeMotionLength(PyObject *self, Piavca::Motion *mot = NULL, float len = 1.0);
...
public:
    SwigDirector_TimeOffset(PyObject *self, Piavca::Motion *mot = NULL, float offs = 0.0);
...
private:
    mutable swig::PyObject_var vtable[36];
#endif
...
public:
    SwigDirector_BlendBetween(PyObject *self, Piavca::Motion *m1 = NULL, Piavca::Motion *m2 = NULL, float _blend = 0.0);
...
class SwigDirector_MultiBlend : public Piavca::MultiBlend, public Swig::Director {

public:
    SwigDirector_MultiBlend(PyObject *self);
    SwigDirector_MultiBlend(PyObject *self, Piavca::MotionVec const &mv);
    SwigDirector_MultiBlend(PyObject *self, Piavca::MultiBlend const &ma);
    virtual ~SwigDirector_MultiBlend();
    virtual Piavca::Motion *clone();
    virtual Piavca::tstring getClassName();
    virtual void create();
    virtual void printInfo();
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (method == NULL) {
          std::string msg = "Method in class MultiBlend doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
...
public:
    ...
    virtual void updateListenersSwigPublic() {
      Piavca::ChoiceMotion::updateListeners();
    }
...
private:
    mutable swig::PyObject_var vtable[34];
#endif

};


class SwigDirector_EventMapChoice : public Piavca::EventMapChoice, public Swig::Director {

public:
    SwigDirector_EventMapChoice(PyObject *self);
    SwigDirector_EventMapChoice(PyObject *self, Piavca::MotionVec const &mv);
    SwigDirector_EventMapChoice(PyObject *self, Piavca::EventMapChoice const &emc);
    virtual ~SwigDirector_EventMapChoice();
    virtual Piavca::Motion *clone();
    virtual Piavca::tstring getClassName();
    virtual void create();
    virtual void printInfo();
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (method == NULL) {
          std::string msg = "Method in class EventMapChoice doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
...
class SwigDirector_MotionGraph : public Piavca::MotionGraph, public Swig::Director {

public:
    SwigDirector_MotionGraph(PyObject *self);
    SwigDirector_MotionGraph(PyObject *self, Piavca::MotionVec const &mv);
    SwigDirector_MotionGraph(PyObject *self, Piavca::MotionGraph const &mg);
    virtual ~SwigDirector_MotionGraph();
    virtual Piavca::Motion *clone();
    virtual Piavca::tstring getClassName();
    virtual void create();
    virtual void printInfo();
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (method == NULL) {
          std::string msg = "Method in class MotionGraph doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
...
public:
    SwigDirector_ZeroMotion(PyObject *self);
...
class SwigDirector_ExpMapMotion : public Piavca::ExpMapMotion, public Swig::Director {

public:
    SwigDirector_ExpMapMotion(PyObject *self, Piavca::Motion *mot = NULL);
    SwigDirector_ExpMapMotion(PyObject *self, std::vector< Piavca::TangentSpace,std::allocator< Piavca::TangentSpace > > tangents, Piavca::Motion *mot = NULL);
    SwigDirector_ExpMapMotion(PyObject *self, Piavca::ExpMapMotion const &em);
    virtual ~SwigDirector_ExpMapMotion();
    virtual Piavca::Motion *clone();
    virtual Piavca::tstring getClassName();
    virtual void create();
    virtual void printInfo();
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (method == NULL) {
          std::string msg = "Method in class ExpMapMotion doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
...
class SwigDirector_LogMapMotion : public Piavca::LogMapMotion, public Swig::Director {

public:
    SwigDirector_LogMapMotion(PyObject *self, Piavca::Motion *mot = NULL);
    SwigDirector_LogMapMotion(PyObject *self, std::vector< Piavca::TangentSpace,std::allocator< Piavca::TangentSpace > > tangents, Piavca::Motion *mot = NULL);
    SwigDirector_LogMapMotion(PyObject *self, Piavca::LogMapMotion const &em);
    virtual ~SwigDirector_LogMapMotion();
    virtual Piavca::Motion *clone();
    virtual Piavca::tstring getClassName();
    virtual void create();
    virtual void printInfo();
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (method == NULL) {
          std::string msg = "Method in class LogMapMotion doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
...
class SwigDirector_AvatarMotion : public Piavca::AvatarMotion, public Swig::Director {

public:
    SwigDirector_AvatarMotion(PyObject *self, Piavca::Avatar *av = NULL, bool _global = true);
    virtual ~SwigDirector_AvatarMotion();
    virtual Piavca::Motion *clone();
    virtual Piavca::tstring getClassName();
    virtual void create();
    virtual void printInfo();
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (method == NULL) {
          std::string msg = "Method in class AvatarMotion doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
