...
class Bound(_object):
    ...
    if _newclass:min = property(_Piavca_base.Bound_min_get, _Piavca_base.Bound_min_set)
    __swig_setmethods__["max"] = _Piavca_base.Bound_max_set
    __swig_getmethods__["max"] = _Piavca_base.Bound_max_get
    if _newclass:max = property(_Piavca_base.Bound_max_get, _Piavca_base.Bound_max_set)
    def __init__(self, *args): 
