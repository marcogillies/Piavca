...
class LoopMotion(PostureBlend):
    ...
    """
    __swig_setmethods__ = {}
    for _s in [PostureBlend]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, LoopMotion, name, value)
    __swig_getmethods__ = {}
    for _s in [PostureBlend]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
