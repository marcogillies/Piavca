...
class PyTimeCallback(TimeCallback):
    ...
    def __init__(self, *args): 
        ...
        """
        this = _Piavca_base.new_PyTimeCallback(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _Piavca_base.delete_PyTimeCallback
    __del__ = lambda self : None;
    def init(*args):
        """
        ...
        It's called when the callback is registered         
        """
        return _Piavca_base.PyTimeCallback_init(*args)
    ...
    def timeStep(*args):
        ...
        It's called every frame with by the API         
        """
        return _Piavca_base.PyTimeCallback_timeStep(*args)

PyTimeCallback_swigregister = _Piavca_base.PyTimeCallback_swigregister
...
class PyAvatarTimeCallback(AvatarTimeCallback):
    ...
    def __init__(self, *args): 
        ...
        """
        this = _Piavca_base.new_PyAvatarTimeCallback(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _Piavca_base.delete_PyAvatarTimeCallback
    __del__ = lambda self : None;
    def init(*args):
        """
        ...
        It's called when the callback is registered         
        """
        return _Piavca_base.PyAvatarTimeCallback_init(*args)
    ...
    def timeStep(*args):
        ...
        It's called every frame with by the API which passes in the avatar to which the callback is attatched         
        """
        return _Piavca_base.PyAvatarTimeCallback_timeStep(*args)

PyAvatarTimeCallback_swigregister = _Piavca_base.PyAvatarTimeCallback_swigregister
