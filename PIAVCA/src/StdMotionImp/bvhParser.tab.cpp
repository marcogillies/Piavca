...
#line 36 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
...
#line 130 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
...
{
       0,   151,   151,   156,   173,   176,   177,   180,   190,   194,
     195,   198,   225,   226,   227,   228,   231,   232,   233,   236,
     249,   281,   284,   287,   290,   291,   294
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 151 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {
  ...
  case 3:
#line 156 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {
  ...
  case 4:
#line 173 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {delete (yyvsp[0].intList);;}
    break;

  case 5:
#line 176 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {(yyval.intList) = (yyvsp[-1].intList);;}
    break;

  case 6:
#line 177 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {(yyval.intList) = new vector<int>();;}
    break;

  case 7:
#line 181 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {
     if(currentTrack >= 0)
       {
  ...
  case 8:
#line 191 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {currentChannel = 0;;}
    break;

  case 9:
#line 194 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {;}
    break;

  case 10:
#line 195 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {;}
    break;

  case 11:
#line 198 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {
				  if(currentTrack >= 0)
				    {
				      if((yyvsp[0].intVal) >= 0)
  ...
  case 12:
#line 225 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
  ...
  case 13:
#line 226 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {(yyval.intList) = (yyvsp[-1].intList);;}
    break;

  case 14:
#line 227 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {(yyval.intList) = (yyvsp[0].intList);;}
    break;

  case 15:
#line 228 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {(yyval.intList) = new vector<int>();;}
    break;

  case 16:
#line 231 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {;}
    break;

  case 17:
#line 232 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {;}
    break;

  case 18:
#line 233 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {;}
    break;

  case 19:
#line 237 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {
  ...
  case 20:
#line 249 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {	
 ...
 ;}
  ...
  case 21:
#line 281 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {;}
    break;

  case 22:
#line 284 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {	g_noFrames = (yyvsp[0].intVal);;}
    break;

  case 23:
#line 287 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {	frameTime = (yyvsp[0].floatVal); ;}
    break;

  case 24:
#line 290 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {;}
    break;

  case 25:
#line 291 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {;}
    break;

  case 26:
#line 295 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
    {
			if(currentTrack < 0)
			{	
		 ...
		 if(currentTrack < 0)
	      {
			if(rootChannel[currentChannel] > 2 && rootChannel[currentChannel] < 6)
			{
			    ...
			    if (g_bNoRootPosCorrection)
			    {
					...
					{
					case 0: 
						currentRootPos += Vec::XAxis()*(yyvsp[0].floatVal);
						break;
					case 1: 
						currentRootPos += Vec::YAxis()*(yyvsp[0].floatVal);
						break;
					case 2: 
						currentRootPos += Vec::ZAxis()*(yyvsp[0].floatVal);
						break;
					default:
						break;
					}
			...
			else
			{
			    ...
			    float angle = Piavca::degToRad((yyvsp[0].floatVal));
			    if(g_ReverseOrder)
...
#line 433 "f:\\code\\Piavca\\src\\StdMotionImp\\bvhParser.ypp"
